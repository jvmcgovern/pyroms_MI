...
if 1 == 1:
    ...
    crocofiles_bc_dir = '/media/dskfour/CS1KM_19932021_biascorrection/'
    ...
    for iyear in range(Ystart, Yend + 1):
        for imonth in range(Mstart, Mend + 1):
            ...
            bryname = crocofiles_bcd_dir + 'croco_bry_my_bc_mthMERCATOR_hc50m_MSL_ng' + '_Y' + str(iyear) + 'M' \
                      + str(imonth).zfill(2) + '.nc'
