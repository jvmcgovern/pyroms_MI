...
if 1 == 1:
    ...
    # ininame = crocofiles_dir + 'croco_ini_MERCATOR_hc50m' + '_Y' + str(Yini) + 'M' + str(Mini).zfill(
    #     2) + '.nc'
    ininame = crocofiles_dir + 'croco_ini_MERCATOR_hc50m_bc' + '_Y' + str(Yini) + 'M' + str(Mini).zfill(
        2) + '.nc'
    ...
    temp = glor.interp3d(ncphyo, 'thetao_bc', tndx_glo, Nzgoodmin, depthg, z_rho, iminT, imaxT, jminT, jmaxT, LonT, LatT,
                         coefT, elemT,  'add_offset')
    ...
    salt = glor.interp3d(ncphyo, 'so_bc', tndx_glo, Nzgoodmin, depthg, z_rho, iminT, imaxT, jminT, jmaxT, LonT, LatT,
                         coefT, elemT, 'add_offset')
    ...
    ncini['Alkalini'][tndx_ini, :, :, :] = ((talk1+talk2)/2)*1000
