    ...
    if comp_horzinterp == 1:
        ...
        for k in progressbar(range(Nz), ' uv : ', 40):
            ...
            (u2d, Nzgood_u) = interp_tracers(nc, 'uo', tndx_glo, k, iminU, imaxU,
                                             jminU, jmaxU, LonU, LatU, coefU, elemU)
            (v2d, Nzgood_v) = interp_tracers(nc, 'vo', tndx_glo, k, iminV, imaxV,
                                             jminV, jmaxV, LonV, LatV, coefV, elemV)
...
def create_bryfile(bryname, grdname, title, obc,
    ...
    if obc[0] == 1:
        ...
        nc_nh4_south.long_name = 'southern boundary total alkalinity'
...
def interp_bry(obctype, ncglo, ncbgco, tndx_glo, ncbry, tndx_bry,
    ...
    temp_bry = glor.interp3d(ncglo, 'thetao', tndx_glo, Nzgoodmin, depth, z_rho,
                             iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                             LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    salt_bry = glor.interp3d(ncglo, 'so', tndx_glo, Nzgoodmin, depth, z_rho,
                             iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                             LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    no3_bry = glor.interp3d(ncbgco, 'no3', tndx_glo, Nzgoodmin, depth, z_rho,
                            iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                            LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    po4_bry = glor.interp3d(ncbgco, 'po4', tndx_glo, Nzgoodmin, depth, z_rho,
                            iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                            LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    si_bry = glor.interp3d(ncbgco, 'si', tndx_glo, Nzgoodmin, depth, z_rho,
                           iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                           LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    o2_bry = glor.interp3d(ncbgco, 'o2', tndx_glo, Nzgoodmin, depth, z_rho,
                           iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                           LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    dic_bry = glor.interp3d(ncbgco, 'dissic', tndx_glo, Nzgoodmin, depth, z_rho,
                            iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                            LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    doc_bry = glor.interp3d(ncbgco, 'dissoc', tndx_glo, Nzgoodmin, depth, z_rho,
                            iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                            LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    fe_bry = glor.interp3d(ncbgco, 'fe', tndx_glo, Nzgoodmin, depth, z_rho,
                           iminT_bry, imaxT_bry, jminT_bry, jmaxT_bry,
                           LonT_bry, LatT_bry, coefT_bry, elemT_bry)
    ...
    if obctype == 's':
        ...
        ncbry['DIC_south'][tndx_bry, :, :] = dic_bry[:, 0, :]
        ncbry['DOC_south'][tndx_bry, :, :] = doc_bry[:, 0, :]
        ncbry['NH4_south'][tndx_bry, :, :] = nh4_bry[:, 0, :]
        ...
        ncbry['DIC_north'][tndx_bry, :, :] = dic_bry[:, -1, :]
        ncbry['DOC_north'][tndx_bry, :, :] = doc_bry[:, -1, :]
        ncbry['NH4_north'][tndx_bry, :, :] = nh4_bry[:, -1, :]
        ...
        ncbry['DIC_east'][tndx_bry, :, :] = dic_bry[:, :, 0]
        ncbry['DOC_east'][tndx_bry, :, :] = doc_bry[:, :, 0]
        ncbry['NH4_east'][tndx_bry, :, :] = nh4_bry[:, :, 0]
        ...
        ncbry['DIC_west'][tndx_bry, :, :] = dic_bry[:, :, -1]
        ncbry['DOC_west'][tndx_bry, :, :] = doc_bry[:, :, -1]
        ncbry['NH4_west'][tndx_bry, :, :] = nh4_bry[:, :, -1]
