...
if 1 == 1:
    ...
    ininame = crocofiles_dir + 'croco_ini_BFM_MERCATOR_hc50m_MSL_ng' + '_Y' + str(Yini) + 'M' + str(Mini).zfill(
        2) + '.nc'
    ...
    glor.create_ini_BFM(ininame, grdname, title, theta_s, theta_b, hc, N, Tini, vtransform)
    ...
    ncini['O3c'][tndx_ini, :, :, :] = dissic*1000
    ...
    ncini['O3h'][tndx_ini, :, :, :] = results["alkalinity"]
