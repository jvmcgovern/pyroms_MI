...
if 1 == 1:
    ...
    bryname = crocofiles_dir + 'croco_bry_PHYBIO_CELTIC.nc'
    ...
    mercator_PHY_files = sorted(glob.glob(glorysfiles_dir +
                                          'CMEMS_v5r1_IBI_PHY_MY_PdE_01dav_2005????_2005????_R*_RE01.nc'))

    mercator_BIO_files = sorted(glob.glob(glorysfiles_dir +
                                          'CMEMS_v5r1_IBI_BIO_MY_PdE_01dav_2005????_2005????_R*_RE01.nc'))
    ...
    for mpf in np.arange(0, Tend-Tstart + 1, glorys_step):
        ...
        if obc[1] == 1:
            ...
            ncbry = glor.interp_bry('e', ncglo, ncbgco, tndx_glo, ncbry, tndx_bry,
                                    ...
                                    coefT_east,
                                    LonU_east, LatU_east, iminU_east, imaxU_east, jminU_east, jmaxU_east, elemU_east,
                                    coefU_east,
                                    LonV_east, LatV_east, iminV_east, imaxV_east, jminV_east, jmaxV_east, elemV_east,
                                    coefV_east)
        ...
        if obc[3] == 1:
            ...
            ncbry = glor.interp_bry('w', ncglo, ncbgco, tndx_glo, ncbry, tndx_bry,
                                    ...
                                    coefT_west,
                                    LonU_west, LatU_west, iminU_west, imaxU_west, jminU_west, jmaxU_west, elemU_west,
                                    coefU_west,
                                    LonV_west, LatV_west, iminV_west, imaxV_west, jminV_west, jmaxV_west, elemV_west,
                                    coefV_west)
