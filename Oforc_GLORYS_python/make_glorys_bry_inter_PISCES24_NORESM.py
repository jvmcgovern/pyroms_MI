...
if 1 == 1:
    ...
    # grdname = crocofiles_dir + 'CELTIC_grd_v6_MSL_h8.nc'  # LAT to MSL included, hmin = 8m
    ...
    for iyear in range(Ystart, Yend + 1):
        for imonth in range(Mstart, Mend + 1):
            ...
            bryname = crocofiles_dir + 'croco_bry_MERCATOR_GLO_interp3rd' + '_Y' + str(iyear) + 'M' \
            ...
            if imonth is 12:
                ...
                mercator_PHY_files_post1 = sorted(glob.glob(glorysfiles_dir +
                                                            glorys_prefix + str(iyear) +
                                                            str(imonth+1).zfill(2) + str(1).zfill(2) + glorys_ending))
                mercator_PHY_files_post2 = sorted(glob.glob(glorysfiles_dir +
                                                            glorys_prefix + str(iyear) +
            ...
            if len(mercator_BIO_files_pre) == 0:
                mercator_BIO_files = mercator_BIO_files_main + mercator_BIO_files_main + mercator_BIO_files_post
            else:
                mercator_BIO_files = mercator_BIO_files_pre + mercator_BIO_files_main + mercator_BIO_files_post
            ...
            for mpf in np.arange(0, Tend - Tstart + 1, glorys_step):
                ...
                if PISCES_NORESM_interpd is 1:
                    ...
                    ncbry['talk_time'][0] = Tinin1
                    ncbry['no3_time'][1] = Tinin2
                    ncbry['po4_time'][1] = Tinin2
                    ncbry['si_time'][1] = Tinin2
                    ncbry['o2_time'][1] = Tinin2
                    ncbry['dic_time'][1] = Tinin2
                    ncbry['talk_time'][1] = Tinin2
                    ncbry['no3_time'][2] = Tinin3
                    ncbry['po4_time'][2] = Tinin3
                    ncbry['si_time'][2] = Tinin3
                    ncbry['o2_time'][2] = Tinin3
                    ncbry['dic_time'][2] = Tinin3
                    ncbry['talk_time'][2] = Tinin3

                    # PISCES variables get their timestamps
                    ncbry['fer_time'][0] = np.float64(Tinip1)
                    ncbry['nh4_time'][0] = np.float64(Tinip1)
                    ncbry['calc_time'][0] = np.float64(Tinip1)
                    ncbry['poc_time'][0] = np.float64(Tinip1)
                    ncbry['phy_time'][0] = np.float64(Tinip1)
                    ncbry['zoo_time'][0] = np.float64(Tinip1)
                    ncbry['doc_time'][0] = np.float64(Tinip1)
                    ncbry['dia_time'][0] = np.float64(Tinip1)
                    ncbry['mes_time'][0] = np.float64(Tinip1)
                    ncbry['bsi_time'][0] = np.float64(Tinip1)
                    ncbry['bfe_time'][0] = np.float64(Tinip1)
                    ncbry['goc_time'][0] = np.float64(Tinip1)
                    ncbry['sfe_time'][0] = np.float64(Tinip1)
                    ncbry['dfe_time'][0] = np.float64(Tinip1)
                    ncbry['dsi_time'][0] = np.float64(Tinip1)
                    ncbry['nfe_time'][0] = np.float64(Tinip1)
                    ncbry['nch_time'][0] = np.float64(Tinip1)
                    ncbry['dch_time'][0] = np.float64(Tinip1)
                    ncbry['fer_time'][1] = np.float64(Tinip2)
                    ncbry['nh4_time'][1] = np.float64(Tinip2)
                    ncbry['calc_time'][1] = np.float64(Tinip2)
                    ncbry['poc_time'][1] = np.float64(Tinip2)
                    ncbry['phy_time'][1] = np.float64(Tinip2)
                    ncbry['zoo_time'][1] = np.float64(Tinip2)
                    ncbry['doc_time'][1] = np.float64(Tinip2)
                    ncbry['dia_time'][1] = np.float64(Tinip2)
                    ncbry['mes_time'][1] = np.float64(Tinip2)
                    ncbry['bsi_time'][1] = np.float64(Tinip2)
                    ncbry['bfe_time'][1] = np.float64(Tinip2)
                    ncbry['goc_time'][1] = np.float64(Tinip2)
                    ncbry['sfe_time'][1] = np.float64(Tinip2)
                    ncbry['dfe_time'][1] = np.float64(Tinip2)
                    ncbry['dsi_time'][1] = np.float64(Tinip2)
                    ncbry['nfe_time'][1] = np.float64(Tinip2)
                    ncbry['nch_time'][1] = np.float64(Tinip2)
                    ncbry['dch_time'][1] = np.float64(Tinip2)
                    ncbry['fer_time'][2] = np.float64(Tinip3)
                    ncbry['nh4_time'][2] = np.float64(Tinip3)
                    ncbry['calc_time'][2] = np.float64(Tinip3)
                    ncbry['poc_time'][2] = np.float64(Tinip3)
                    ncbry['phy_time'][2] = np.float64(Tinip3)
                    ncbry['zoo_time'][2] = np.float64(Tinip3)
                    ncbry['doc_time'][2] = np.float64(Tinip3)
                    ncbry['dia_time'][2] = np.float64(Tinip3)
                    ncbry['mes_time'][2] = np.float64(Tinip3)
                    ncbry['bsi_time'][2] = np.float64(Tinip3)
                    ncbry['bfe_time'][2] = np.float64(Tinip3)
                    ncbry['goc_time'][2] = np.float64(Tinip3)
                    ncbry['sfe_time'][2] = np.float64(Tinip3)
                    ncbry['dfe_time'][2] = np.float64(Tinip3)
                    ncbry['dsi_time'][2] = np.float64(Tinip3)
                    ncbry['nfe_time'][2] = np.float64(Tinip3)
                    ncbry['nch_time'][2] = np.float64(Tinip3)
                    ncbry['dch_time'][2] = np.float64(Tinip3)
                ...
                if obc[0] == 1:
                    ...
                    ncbry = glor.interp_bry_GLO_PISCES_NORESM('s', PISCES_NORESM_interpd, Tininxn,
                ...
                if obc[1] == 1:
                    ...
                    ncbry = glor.interp_bry_GLO_PISCES_NORESM('e', PISCES_NORESM_interpd, Tininxn,
                                                              ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                              NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[2] == 1:
                    ...
                    ncbry = glor.interp_bry_GLO_PISCES_NORESM('n', PISCES_NORESM_interpd, Tininxn,
                                                              ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                              NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[3] == 1:
                    ...
                    ncbry = glor.interp_bry_GLO_PISCES_NORESM('w', PISCES_NORESM_interpd, Tininxn,
                                                              ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                              NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
            ...
            #  End loop on time
            #
            # # Trialling detiding (even though there's no tidal forcing in GLO)
            # us_arr = np.array(ncbry['u_south'])
            # us_fit = tt.t_tide(us_arr[:, 0, 0])
            ncbr.close()
