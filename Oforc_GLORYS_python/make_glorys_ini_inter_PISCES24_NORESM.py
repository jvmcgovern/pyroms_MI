...
if 1 == 1:
    ...
    ininame = crocofiles_dir + 'croco_ini_MERCATOR_GLO' + '_Y' + str(Yini) + 'M' + str(Mini).zfill(
        2) + '.nc'
    ...
    # MERCATOR GLORYS DAILY MODEL TIMESTAMPED AT NOON, LEAVING INITIAL TIME TO MIDNIGHT TO ALLOW FOR
