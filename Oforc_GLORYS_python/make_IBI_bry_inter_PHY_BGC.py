        ...
        for imonth in range(Mstart, Mend + 1):
            ...
            for mpf in np.arange(0, Tend - Tstart + 1, glorys_step):
                ...
                if obc[0] == 1:
                    ...
                    ncbry = glor.interp_bry_BGC_PHY('s', PISCES_NORESM_interpd, Tininxn,
                ...
                if obc[1] == 1:
                    ...
                    ncbry = glor.interp_bry_BGC_PHY('e', PISCES_NORESM_interpd, Tininxn,
                                                    ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                    ncphymprio, ncphymcuro, ncphymposo,
                                                    NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[2] == 1:
                    ...
                    ncbry = glor.interp_bry_BGC_PHY('n', PISCES_NORESM_interpd, Tininxn,
                                                    ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                    ncphymprio, ncphymcuro, ncphymposo,
                                                    NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[3] == 1:
                    ...
                    ncbry = glor.interp_bry_BGC_PHY('w', PISCES_NORESM_interpd, Tininxn,
                                                    ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                    ncphymprio, ncphymcuro, ncphymposo,
                                                    NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
