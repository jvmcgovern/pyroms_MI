...
if 1 == 1:
    ...
    for iyear in range(Ystart, Yend + 1):
        for imonth in range(Mstart, Mend + 1):
            ...
            bryname = crocofiles_dir + 'croco_bry_BFM_MERCATOR_hc50m_MSL_ng' + '_Y' + str(iyear) + 'M' \
                      + str(imonth).zfill(2) + '.nc'
            ...
            #
            glor.create_bryfile_BFM(bryname, grdname, title, obc,
            ...
            for mpf in np.arange(0, Tend - Tstart + 1, glorys_step):
                ...
                if obc[0] == 1:
                    ...
                    ncbry = glor.interp_bry_BFM('s', PISCES_NORESM_interpd, Tininxn,
                ...
                if obc[1] == 1:
                    ...
                    ncbry = glor.interp_bry_BFM('e', PISCES_NORESM_interpd, Tininxn,
                                                ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                ncphymprio, ncphymcuro, ncphymposo,
                                                NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[2] == 1:
                    ...
                    ncbry = glor.interp_bry_BFM('n', PISCES_NORESM_interpd, Tininxn,
                                                ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                ncphymprio, ncphymcuro, ncphymposo,
                                                NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
                ...
                if obc[3] == 1:
                    ...
                    ncbry = glor.interp_bry_BFM('w', PISCES_NORESM_interpd, Tininxn,
                                                ncglo, ncpisprio, ncpiscuro, ncpisposo,
                                                ncphymprio, ncphymcuro, ncphymposo,
                                                NORESMfiles_dir, NORESM_prefix, NIVAvars, NORESM_ending,
