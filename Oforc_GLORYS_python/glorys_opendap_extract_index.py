...
urlU = \
  "http://tds.mercator-ocean.fr/thredds/dodsC/glorys12v1-daily-gridU"
# vozocrtx (zonal velocity), sozotaux (zonal wind stress)
urlV = \
  "http://tds.mercator-ocean.fr/thredds/dodsC/glorys12v1-daily-gridV"
# vomecrty (meridional velocity), sometauy (meridional windstress)
url2D = "http://tds.mercator-ocean.fr/thredds/dodsC/glorys12v1-daily-grid2D"
# sossheig
