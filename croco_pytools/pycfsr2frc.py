...
class RomsGrid(RomsGrid):
    ...
    def create_frc_nc(self, frcfile, sd, ed, nr, cl, madeby, bulk):
        ...
        for key, value in zip(list(frc_vars.keys()), list(frc_vars.values())):
...
if __name__ == '__main__':
    ...
    for cfsr_key, cfsr_file in zip(list(cfsr_files.keys()), list(cfsr_files.values())):
        ...
        if cfsr_key == list(cfsr_files.keys())[0]:
