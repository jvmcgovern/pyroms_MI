...
from py_roms2roms import vertInterp
...
if __name__ == '__main__':
    ...
    mercator_dir = '/media/dskone/CELTIC/CMEMS_IBI/'

    # ROMS path and filename information
    roms_dir = '/home/pete/PycharmProjects/pyroms_MI/CELTIC_SEA/'
    roms_grd = 'CELTIC_grd_v5.nc'

    # Set sigma transformation parameters
    if 'CELTIC_grd_v5.nc' in roms_grd:
        chd_sigma_params = dict(theta_s=7, theta_b=0, hc=20, N=20)
        ini_filename = 'croco_ini_PHY_CELTIC.nc'
        # ini_filename = 'croco_ini_BIO_CELTIC.nc'
        ini_date = '20050101'

    elif 'roms_grd_NA2009_7pt5km.nc' in roms_grd:
        chd_sigma_params = dict(theta_s=6, theta_b=0, hc=120, N=32)
        ini_filename = 'generic.nc'
        ini_date = '20050101'
    ...
    elif 'grd_lions1500.nc' in roms_grd:
        chd_sigma_params = dict(theta_s=7, theta_b=2, hc=300, N=50)
        ini_filename = 'ini_lions1500.nc'
        ini_date = '20061228'
    ...
    if 'ORCA' in mercator_dir:
        mercator_ssh_file = mercator_dir + '*y%sm%sd%s_gridT*.nc' % date_str
        # mercator_ssh_file = mercator_dir + '*y%sm%sd%s_grid2D*.nc' %(ini_date[:4], ini_date[4:6], ini_date[6:])
        mercator_temp_file = mercator_dir + '*y%sm%sd%s_gridT*.nc' % date_str
        mercator_salt_file = mercator_dir + '*y%sm%sd%s_gridS*.nc' % date_str
        mercator_u_file = mercator_dir + '*y%sm%sd%s_gridU*.nc' % date_str
        mercator_v_file = mercator_dir + '*y%sm%sd%s_gridV*.nc' % date_str

    elif 'IBI_daily' in mercator_dir or 'ibi' in mercator_dir or 'IBI' in mercator_dir:
        ...
        mercator_ssh_file = 'CMEMS_v5r1_IBI_PHY_MY_PdE_01dav_%s_%s_R*_RE01.nc' % (ini_date, ini_date)
        ...
        # mercator_chl_file = 'CMEMS_v5r1_IBI_BIO_MY_PdE_01dav_%s_%s_R*_RE01.nc' % (ini_date, ini_date)
        # mercator_po4_file = mercator_dir + mercator_chl_file
        # mercator_phyc_file = mercator_dir + mercator_chl_file
        # mercator_si_file = mercator_dir + mercator_chl_file
        # mercator_nh4_file = mercator_dir + mercator_chl_file
        # mercator_fe_file = mercator_dir + mercator_chl_file
        # mercator_no3_file = mercator_dir + mercator_chl_file
        # mercator_nppv_file = mercator_dir + mercator_chl_file
        # mercator_zeu_file = mercator_dir + mercator_chl_file
        # mercator_o2_file = mercator_dir + mercator_chl_file
        # mercator_spco2_file = mercator_dir + mercator_chl_file
        # mercator_dissic_file = mercator_dir + mercator_chl_file
        # mercator_ph_file = mercator_dir + mercator_chl_file
        # mercator_chl_file = mercator_dir + mercator_chl_file
    ...
    elif 'local/tmp/3/ema' in mercator_dir:
        mercator_ssh_file = 'GLOB_MERC_PHY_001_024_%s-%s-%s.nc' % (ini_date[:4], ini_date[4:6], ini_date[6:])
        mercator_temp_file = mercator_dir + mercator_ssh_file
        mercator_salt_file = mercator_dir + mercator_ssh_file
        mercator_u_file = mercator_dir + mercator_ssh_file
        mercator_v_file = mercator_dir + mercator_ssh_file
        ...
        # Exception
        mercator_ssh_file = 'generic_%s_%s_R*_RE01.nc' % (ini_date, ini_date)
        mercator_temp_file = mercator_dir + mercator_ssh_file
        mercator_salt_file = mercator_dir + mercator_ssh_file
        mercator_u_file = mercator_dir + mercator_ssh_file
        mercator_v_file = mercator_dir + mercator_ssh_file
    ...
    # mercator_po4_file = glob.glob(mercator_po4_file)
    # mercator_phyc_file = glob.glob(mercator_phyc_file)
    # mercator_si_file = glob.glob(mercator_si_file)
    # mercator_nh4_file = glob.glob(mercator_nh4_file)
    # mercator_fe_file = glob.glob(mercator_fe_file)
    # mercator_no3_file = glob.glob(mercator_no3_file)
    # mercator_nppv_file = glob.glob(mercator_nppv_file)
    # mercator_zeu_file = glob.glob(mercator_zeu_file)
    # mercator_o2_file = glob.glob(mercator_o2_file)
    # mercator_spco2_file = glob.glob(mercator_spco2_file)
    # mercator_dissic_file = glob.glob(mercator_dissic_file)
    # mercator_ph_file = glob.glob(mercator_ph_file)
    # mercator_chl_file = glob.glob(mercator_chl_file)
    ...
    mercator_vars = OrderedDict([('zos', mercator_ssh_file),
                                 ...
                                 ('uo', mercator_u_file),
                                 ('vo', mercator_v_file)])
    # mercator_vars = OrderedDict([('po4', mercator_v_file),
    #                              ('phyc', mercator_v_file),
    #                              ('si', mercator_v_file),
    #                              ('nh4', mercator_v_file),
    #                              ('chl', mercator_v_file),
    #                              ('fe', mercator_v_file),
    #                              ('no3', mercator_v_file),
    #                              ('nppv', mercator_v_file),
    #                              ('zeu', mercator_v_file),
    #                              ('o2', mercator_v_file),
    #                              ('spco2', mercator_v_file),
    #                              ('dissic', mercator_v_file),
    #                              ('ph', mercator_v_file)])
    ...
    for domx in np.arange(ndomx):
        ...
        for domy in np.arange(ndomy):
            ...
            for mercator_var, mercator_file in zip(list(mercator_vars.keys()), list(mercator_vars.values())):
                ...
                with netcdf.Dataset(romsini.romsfile, 'a') as nc:
                    ...
                    elif mercator.vartype in 'thetao':

                        mercator.dataout *= romsgrd.mask3d()
                        nc.variables['temp'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]

                    elif mercator.vartype in 'so':

                        mercator.dataout *= romsgrd.mask3d()
                        nc.variables['salt'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]

                    # elif mercator.vartype in 'dissic':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['DIC'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'o2':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['O2'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'po4':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['PO4'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'si':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['Si'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'fe':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['FER'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'no3':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['NO3'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
                    #
                    # elif mercator.vartype in 'nh4':
                    #
                    #     mercator.dataout *= romsgrd.mask3d()
                    #     nc.variables['NH4'][:, :, j0:j1, i0:i1] = mercator.dataout[np.newaxis]
