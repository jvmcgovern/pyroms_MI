...
CELTIC and TPXO8 grid files. TPXO8 grid file is kept in the same directory as data files:
...
# /home/pete/PycharmProjects/pyroms_MI/examples/make_tide/make_tide.py
...
# import examples.make_tide.CGrid_TPXO8.get_nc_CGrid_TPXO8
from examples.make_tide.CGrid_TPXO8 import get_nc_CGrid_TPXO8
from examples.make_tide.CGrid_TPXO8.tidal_ellipse import ap2ep
...
eta, xi = lat.shape
# read weights file
wts_file_t = 'remap_weights_TPXO8_to_CELTIC_bilinear_t_to_rho.nc'
wts_file_u = 'remap_weights_TPXO8_to_CELTIC_bilinear_u_to_rho.nc'
wts_file_v = 'remap_weights_TPXO8_to_CELTIC_bilinear_v_to_rho.nc'

wts_file_t_lr = 'remap_weights_TPXO8atlas6_to_CELTIC_bilinear_t_to_rho.nc'
wts_file_u_lr = 'remap_weights_TPXO8atlas6_to_CELTIC_bilinear_u_to_rho.nc'
wts_file_v_lr = 'remap_weights_TPXO8atlas6_to_CELTIC_bilinear_v_to_rho.nc'

# read TPXO8 files
# pth_tpxo = '/archive/u1/uaf/kate/tides/tpxo8/'
# pth_tpxo = '/home/pete/PycharmProjects/pyroms_MI/Tideforce/TPX/TPX_08/'
# pth_tpxo9atlas = '/home/pete/PycharmProjects/pyroms_MI/Tideforce/TPX/TPX_09/ATLAS_06/'
# srcgrd = get_nc_CGrid_TPXO8(pth_tpxo+'grid_tpxo9_atlas_30_v2.nc ', xrange=(4400, 5100), yrange=(5200, 6500))
# srcgrd_lr = get_nc_CGrid_TPXO8(pth_tpxo9atlas+'grid_tpxo9.v2a.nc', name='TPXO8atlas6', xrange=(920, 1020),
#                                            yrange=(1030, 1300))
os.environ['PYROMS_GRIDID_FILE'] = '/home/pete/PycharmProjects/pyroms_MI/gridid_MI.txt'
...
for cst in consts:
    ...
    if cst in consts1:
        fid = nc.Dataset(pth_tpxo+'hf.'+cst.lower()+'_tpxo8_atlas_30c.nc', 'r')
    ...
    if cst in consts1:
        fid = nc.Dataset(pth_tpxo+'uv.'+cst.lower()+'_tpxo8_atlas_30c.nc', 'r')
    ...
    cmax[k, :, :], ecc, cang[k, :, :], cpha[k, :, :], w = ap2ep(uamp, upha, vamp, vpha)
    cmin[k, :, :] = cmax[k, :, :]*ecc
...
if savedata == 1:
    ...
    # -------------------------------------------------------------------------
    # create nc file
    fh = nc.Dataset('Celtic_tides_otps.nc', 'w')
