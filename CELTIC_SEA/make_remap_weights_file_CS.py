...
grid2_file = 'remap_grid_CELTIC_rho.nc'
interp_file1 = 'remap_weights_IBI_to_CELTIC_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_CELTIC_to_IBI_bilinear_rho_to_t.nc'
map1_name = 'IBI to CELTIC Bilinear Mapping'
map2_name = 'CELTIC to IBI Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_CELTIC_rho.nc'
interp_file1 = 'remap_weights_IBI_to_CELTIC_bilinear_u_to_rho.nc'
interp_file2 = 'remap_weights_CELTIC_to_IBI_bilinear_rho_to_u.nc'
map1_name = 'IBI to CELTIC Bilinear Mapping'
map2_name = 'CELTIC to IBI Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_CELTIC_rho.nc'
interp_file1 = 'remap_weights_IBI_to_CELTIC_bilinear_v_to_rho.nc'
interp_file2 = 'remap_weights_CELTIC_to_IBI_bilinear_rho_to_v.nc'
map1_name = 'IBI to CELTIC Bilinear Mapping'
map2_name = 'CELTIC to IBI Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
# input namelist variables for bilinear remapping at rho points
grid1_file = 'remap_grid_IBI_t.nc'
grid2_file = 'remap_grid_CELTIC_u.nc'
interp_file1 = 'remap_weights_IBI_to_CELTIC_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_CELTIC_to_IBI_bilinear_u_to_t.nc'
map1_name = 'IBI to CELTIC Bilinear Mapping'
map2_name = 'CELTIC to IBI Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
# input namelist variables for bilinear remapping at rho points
grid1_file = 'remap_grid_IBI_t.nc'
grid2_file = 'remap_grid_CELTIC_v.nc'
interp_file1 = 'remap_weights_IBI_to_CELTIC_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_CELTIC_to_IBI_bilinear_v_to_t.nc'
map1_name = 'IBI to CELTIC Bilinear Mapping'
map2_name = 'CELTIC to IBI Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
