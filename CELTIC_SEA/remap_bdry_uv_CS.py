...
# /home/pete/PycharmProjects/pyroms_MI/examples/Arctic_GLORYS/remap_bdry_uv.py
...
def remap_bdry_uv(src_file, src_grd, dst_grd, dmax=0, cdepth=0, kk=0, dst_dir='./'):
    ...
    dst_fileu = dst_dir + dst_file[11:22] + dst_file[32:40] + '_u_bdry_' + dst_grd.name + '.nc'
    ...
    dst_filev = dst_dir + dst_file[11:22] + dst_file[32:40] + '_v_bdry_' + dst_grd.name + '.nc'
    ...
    dst_u_north = pyroms.remapping.z2roms(dst_uz[::-1, Mp - 2:Mp, 0:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                          flood=False, irange=(0, Lp), jrange=(Mp - 2, Mp))
    dst_u_south = pyroms.remapping.z2roms(dst_uz[::-1, 0:2, 0:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                          flood=False, irange=(0, Lp), jrange=(0, 2))
    dst_u_east = pyroms.remapping.z2roms(dst_uz[::-1, 0:Mp, Lp - 2:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                         flood=False, irange=(Lp - 2, Lp), jrange=(0, Mp))
    dst_u_west = pyroms.remapping.z2roms(dst_uz[::-1, 0:Mp, 0:2], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                         flood=False, irange=(0, 2), jrange=(0, Mp))

    dst_v_north = pyroms.remapping.z2roms(dst_vz[::-1, Mp - 2:Mp, 0:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                          flood=False, irange=(0, Lp), jrange=(Mp - 2, Mp))
    dst_v_south = pyroms.remapping.z2roms(dst_vz[::-1, 0:2, 0:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                          flood=False, irange=(0, Lp), jrange=(0, 2))
    dst_v_east = pyroms.remapping.z2roms(dst_vz[::-1, 0:Mp, Lp - 2:Lp], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                         flood=False, irange=(Lp - 2, Lp), jrange=(0, Mp))
    dst_v_west = pyroms.remapping.z2roms(dst_vz[::-1, 0:Mp, 0:2], dst_grdz, dst_grd, Cpos='rho', spval=spval,
                                         flood=False, irange=(0, 2), jrange=(0, Mp))
