...
# /home/pete/PycharmProjects/pyroms_MI/examples/Arctic_GLORYS/remap_bdry.py
...
def remap_bdry(src_file, src_varname, src_grd, dst_grd, dmax=0, cdepth=0, kk=0, dst_dir='./'):
    ...
    dst_file = dst_dir + dst_file[11:22] + dst_file[32:40] + '_' + src_varname + '_bdry_' + dst_grd.name + '.nc'
