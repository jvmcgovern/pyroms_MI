...
class CGrid_GLORYS(object):
    ...
    def __init__(self, lon_t, lat_t, lon_u, lat_u, lon_v, lat_v, mask_t, mask_u, mask_v, depth, depth_bnds, h, name,
                 xrange, yrange):
        ...
        # # a1 = lat_u[yrange[0]:yrange[1]+1, xrange[0]+1:xrange[1]+2] - lat_u[yrange[0]:yrange[1]+1, xrange[0]:xrange[1]+1]
        # # a2 = lon_u[yrange[0]:yrange[1]+1, xrange[0]+1:xrange[1]+2] - lon_u[yrange[0]:yrange[1]+1, xrange[0]:xrange[1]+1]
